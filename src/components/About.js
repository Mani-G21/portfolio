...
const About = () => {
  return (
    <div className="text-white flex w-screen mx-0 text-center font-jakarta relative ">
      <div className="flex flex-col items-center w-4/5 mx-auto h-[70vh] mt-40">
        <img
          src={speechLeftImage}
          alt="aboutMeQuoteImage"
          className="absolute md:w-[20%] md:max-w-[100px] md:left-[5%] md:top-[10%] -rotate-[90deg] w-[80px] top-[5%] left-[2%]"
          style={{
            textShadow: "-50px 50px black"
          }}
        />
        <p className="text-sm md:text-xl lg:text-2xl font-thin tracking-[0.3rem] md:tracking-[0.5rem] lg:tracking-[1rem] mb-8">
        ...
        <img
          ...
          alt="aboutMeQuoteImage"
          className="absolute md:w-[20%] md:max-w-[100px] md:right-[5%] md:top-[50%] w-[80px] top-[75%] right-[2%]"
        />
      </div>
    </div>
  );
