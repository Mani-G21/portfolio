...
const Projects = () => {
  const projects = [
    ...
    },
    {
      name: "Film Fiesta",
      description:
        "Film Fiesta is an innovative movie search website built using React and powered by The Movie Database (TMDb) API. This dynamic application allows users to effortlessly search for their favorite movies, explore trending titles, and discover detailed information about each film, including cast, crew, and plot summaries. With a sleek and intuitive user interface, Film Fiesta provides an engaging and seamless experience for movie enthusiasts. Leveraging the robust TMDb API, the website ensures accurate and up-to-date data. Whether you're looking for the latest blockbuster or a hidden gem, Film Fiesta has got you covered.",
  ...
  return (
    <div className="flex flex-col justify-items-center items-center w-screen h-screen font-jakarta">
      <p className="text-white font-extrabold text-3xl md:text-4xl lg:text-6xl">
        Projects
      </p>
      <p className="text-white text-sm sm:text-sm md:text-xl lg:text-2xl font-thin tracking-[0.2rem] sm:tracking-normal md:tracking-wide lg:tracking-wider mb-4 sm:mb-6 md:mb-8 mt-2">
      ...
      >
        <div className="w-full md:w-[50%] md:h-[100%] flex flex-col p-4 sm:p-6 md:p-12 rounded-3xl items-center">
          <div className="mb-3 sm:mb-5 ml-3 sm:ml-5">
            ...
            <p className="text-xs sm:text-sm md:text-md font-bold tracking-normal sm:tracking-wider md:tracking-widest">
        ...
        <div className="w-full md:w-1/2 rounded-3xl flex flex-wrap flex-col md:flex-row justify-center items-center mt-4 md:mt-0">

          {
            activeProject > 0 && 
            (
              <div className="w-[0%] h-[0%] md:w-[10%] h-[50%] md:h-[80%] bg-black rounded-3xl mb-4 md:mb-0 md:mr-5"></div>

            )    
            
          }
         
          <div className="w-[90vw]  md:h-[80%] lg:h-[80%] md:w-[60%] bg-black rounded-3xl flex flex-col justify-between items-center mt-2">
            ...
            <div className="bg-white w-[85%] h-[50%] md:h-[40%] rounded-lg relative top-[-10%] md:top-[-7%] top-[-6%]">
              <img
          ...
          {
            (activeProject < projects.length - 1) && (
              <div className="w-[0%] md:w-[10%] h-[0%] md:h-[80%] bg-black rounded-3xl mt-4 md:mt-0 md:ml-5"></div>
            )
          }
        </div>
      </div>
